...
.crossBar span {
    ...
    background-color: var(--frame-main-color);
}
...
.el-popover .el-upload .el-button--success {
    color: #3875ff;
}
...
.equipList-table-popover{
  p{
    color: var(--frame-main-color);
    text-align: left;
    font-size: 16px;
    border-bottom: 1px solid var(--frame-main-border1);
    padding-bottom: 5px;
    margin-bottom: 5px;
  }
  .el-button-group{
