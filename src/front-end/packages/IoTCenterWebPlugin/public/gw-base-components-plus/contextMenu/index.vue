    ...
    <transition name="el-fade-in">
        <div @mouseup="this.close" v-show="visible" class="ContextMenu-wrapper">
            <ul :class="['ContextMenu', customClass]" :style="`width: ${width}px;left: ${left}px;top: ${top}px;`">
                <li @mouseup="handleClick($event, item)" class="ContextMenu-item" :class="{'is-disabled': item.disabled}" v-for="item in commands">
...
.ContextMenu {
    ...
    &-item {
        ...
        &:not(.is-disabled):hover {
            background-color: var(--popover-hoverBgColor);
        }
    }
}
</style>