        ...
        mySetChecked (newVal, allHalf) {
            ...
            if (allHalf) {
                ...
                for (let item in this.groupObj) {
                    ...
                    if (window.top[`${this.nodeObject[item].title}-${item}`].length != this.groupObj[item].leng) {
            ...
            list.forEach(item => {
                if (this.nodeObject[item]) {
                    ...
                    if (type == 'add') {
                        let arr = []
                        if (this.searchName) {
                            arr = window.top[`${this.nodeObject[item].title}-${this.nodeObject[item].key}-search`] || []
                        } else {
                            arr = window.top[`${this.nodeObject[item].title}-${this.nodeObject[item].key}`] || []
                        }
