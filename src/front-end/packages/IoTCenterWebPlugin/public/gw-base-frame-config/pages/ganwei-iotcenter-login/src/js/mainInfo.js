export default {
    data() {
        return {
            ...
            {
                name: 'login.button.inputLisenceCode',
                val: 1
            }],
            activeTab: 0
        };
    ...
    methods: {
        ...
        async UploadLicense() {
            ...
            if (this.activeTab == 1) {
                if (!this.licenseForm.code) {
                    this.$message.error(this.$t('login.input.inputLisenceCode'));
                    return;
                }
                let blob = new Blob([this.licenseForm.code], {
            ...
            await this.$api
                ...
                .then(res => {
                    if (res.data.code === 200) {
                        ...
                        this.$message.error(
                            res.data.message ||
                            this.$t('manageLicenses.tips.err'), res
                        );
