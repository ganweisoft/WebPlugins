...
One of the easiest ways to contribute is to participate in discussions on OpenTOMs issues. You can also contribute by submitting pull requests with code changes.
...
Your pull request will now go through extensive checks by the subject matter experts on our team. Please be patient; we have hundreds of pull requests across all of our repositories. Update your pull request according to feedback until it is approved by one of the OpenTOMs team members. After that, one of our team members may adjust the branch you merge into based on the expected release schedule.
